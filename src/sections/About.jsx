        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">I&apos;m based in West Bengal, India and open to remote work worldwide.</p>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-xl md:text-xl font-medium text-gray_gradient text-white">www.linkedin.com/in/sangam911</p>
              </div>
            </div>
          </div>
        </div>
